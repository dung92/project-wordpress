<div class="catcbll_stng_cntnt"><!-- start general setting-->
	<div class="tab-content">
		<div role="tabpanel" class="tab-pane active" id="catcbll_general_tab">
						...
						<div class="container-fluid">
							<div class="row mb-3">
								...
								<div class="col-lg-4 p-0">
									<div class="col-md-12 col-12 p-2 stgrcol save_btn order1 mb-3 text-center">
										<button type="submit" name="submit" id="submit_settings" class="btn btn-primary mx-4"><?php echo __('Save Changes','catcbll');?></button>
										<button type="button" class="btn btn-success" data-toggle="modal" data-target="#shortcodeModal"><?php echo __('Shortcode','catcbll');?></button>
							...
							<div class="row mb-3">														
								...
								<div class="col-lg-6 col-12">															
									...
									<div class="row">
										...
										<div class="col-4">
											<select name="catcbll_custom_btn_position" id="wcatcbll_custom_btn_position">
												...
												<option <?php if($catcbll_custom_btn_position == 'left') echo "selected='selected'";  ?> value="left">Left</option>
												<option <?php if($catcbll_custom_btn_position == 'right') echo "selected='selected'";  ?> value="right">Right</option>
											</select>
									...
									<div class="row">
										<div class="col-8 py-2">
											<label><?php echo __("Custom button alignment","catcbll");?><div class="wcatcblltooltip"><i class="fa fa-question-circle" aria-hidden="true"></i>
			...
			<marquee direction="left" class="marqtg" behavior="scroll" onmouseover="this.stop();" onmouseout="this.start();"><h4><?php echo __(" For Pro Version Demo, Please","catcbll");?> <a href="https://plugins.hirewebxperts.com/" target="_blank"><?php echo __("Click Here","catcbll");?></a></h4></marquee>
		</div>		
	</div>	
</div><!-- close general setting-->
<?php include(WCATCBLL_CART_INC .'/admin/wcatcbll_setting_shortcode.php');?>