 ...
 */
class LibraryDebugPage implements \ShopMagicVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    ...
    public function hooks()
    {
        \add_action('admin_menu', function () {
            ...
            \add_submenu_page($parent_slug, \__('Library report', 'shopmagic-for-woocommerce'), \__('Library report', 'shopmagic-for-woocommerce'), 'manage_options', 'wpdesk-helper-library-report', function () {
