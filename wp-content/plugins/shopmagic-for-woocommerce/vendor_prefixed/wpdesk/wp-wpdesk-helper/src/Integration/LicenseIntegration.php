...
use ShopMagicVendor\WPDesk\License\Page\LicensePage;
 ...
 */
class LicenseIntegration implements \ShopMagicVendor\WPDesk\PluginBuilder\Plugin\Hookable
{
    /** @var LicensePage */
    ...
    {
        $plugin_registry = new \ShopMagicVendor\WPDesk\License\InstalledPlugins();
        $this->license_page = new \ShopMagicVendor\WPDesk\License\Page\LicensePage($plugin_registry);
