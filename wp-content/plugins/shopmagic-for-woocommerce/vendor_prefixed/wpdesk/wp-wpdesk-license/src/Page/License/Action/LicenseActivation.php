 ...
 */
class LicenseActivation implements \ShopMagicVendor\WPDesk\License\Page\Action
{
    /**
     * Plugin data.
     *
    ...
    {
        \add_settings_error('api_key_check_text', 'api_key_check_error', \__('Connection failed to the Subscription Key API server. Try again later.', 'shopmagic-for-woocommerce'), 'error');
    }
    /**
    ...
    {
        \add_settings_error('activate_text', 'activate_msg', \__('Plugin activated. ', 'shopmagic-for-woocommerce') . "{$activate_results['message']}.", 'updated');
    }
    /**
     * Activate license.
     *
