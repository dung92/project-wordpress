...
final class StringType extends AbstractType {
	...
	private function remove_global_regex_modifier( $regex ) {
		return preg_replace_callback( '/(\/[a-z]+)$/', static function ( $modifiers ) {
	...
	public function get_conditions() {
		return [
			'contains'     => __( 'contains', 'shopmagic-for-woocommerce' ),
			'not_contains' => __( 'does not contain', 'shopmagic-for-woocommerce' ),
			'is'           => __( 'is', 'shopmagic-for-woocommerce' ),
			'is_not'       => __( 'is not', 'shopmagic-for-woocommerce' ),
			'starts_with'  => __( 'starts with', 'shopmagic-for-woocommerce' ),
			'ends_with'    => __( 'ends with', 'shopmagic-for-woocommerce' ),
			'regex'        => __( 'matches regex', 'shopmagic-for-woocommerce' ),
			// TODO: those require conditional fields
//			'blank'        => __( 'is blank', 'shopmagic-for-woocommerce' ),
//			'not_blank'    => __( 'is not blank', 'shopmagic-for-woocommerce' ),
		];
	}
}
