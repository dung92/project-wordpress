	...
	protected function get_fields() {
		return [
			( new InputTextField() )
				...
				->set_description_tip( __( 'Insert your API key here which you can create and get from your Mailchimp settings.',
					'shopmagic-for-woocommerce' ) )
				->set_name( 'wc_settings_tab_mailchimp_api_key' ),

			( new SelectField() )
				->set_label( __( 'List', 'shopmagic-for-woocommerce' ) )
				->set_description_tip( __( 'The DEFAULT MailChimp List names to which you want to add clients.',
					'shopmagic-for-woocommerce' ) )
			...
			( new InputTextField() )
				...
				->set_description_tip( __( 'A single text field for seller to include tags (comma separated) to be added to mailchimp upon checkout.',
					'shopmagic-for-woocommerce' ) )
				->set_name( 'wc_settings_tab_mailchimp_tags' ),

			( new Paragraph() )
				->set_description( __( 'Send additional information to Mailchimp list',
					'shopmagic-for-woocommerce' ) ),
