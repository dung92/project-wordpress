...
final class Settings {
	...
	public function save_settings_action() {
		...
		if ( ! empty( $_POST ) && isset( $_POST[ $tab::get_tab_slug() ] ) ) {
			...
			new Notice( __( 'Your settings have been saved.', 'shopmagic-for-woocommerce' ),
	...
	private function get_settings_tabs(): array {
		static $tabs = [];
		if ( empty( $tabs ) ) {
			$tabs = apply_filters( 'shopmagic/core/settings/tabs', [
	...
	private function get_renderer() {
		...
		$resolver_list =
			 ...
			 *
			 */
			apply_filters( 'shopmagic/core/settings/template_resolvers',
				[
