...
jQuery(document).ready(function() {
    ...
    var Rich_Web_Sl_FS_Arr_Type<?php echo $Rich_Web_Slider_Manager[0]->id;?> = jQuery(
        ".Rich_Web_Sl_FS_Arr_Type<?php echo $Rich_Web_Slider_Manager[0]->id;?>").val();
    var answer = true;
    ...
    for (i = 0; i < array_flexible<?php echo $Rich_Web_Slider;?>.length; i++) {
        jQuery("<img class='RW_Fashion_IMG<?php echo $Rich_Web_Slider_Manager[0]->id;?>' />").attr('src',
            array_flexible<?php echo $Rich_Web_Slider;?>[i]).on("load", function() {
            y_flexible<?php echo $Rich_Web_Slider;?>++;
            if (y_flexible<?php echo $Rich_Web_Slider;?> == array_flexible<?php echo $Rich_Web_Slider;?>
                .length) {
                var slider = jQuery('.mis-stage_<?php echo $Rich_Web_Slider_Manager[0]->id;?>')
                    .miSlider({
                ...
                jQuery(".rw_fl_slider_figure<?php echo $Rich_Web_Slider_Manager[0]->id;?>").css(
                    "height", "auto");
...
<script type="text/javascript">
var Rich_Web_Sl_FS_SVis<?php echo $Rich_Web_Slider_Manager[0]->id;?> = document.querySelector(
    ".Rich_Web_Sl_FS_SVis<?php echo $Rich_Web_Slider_Manager[0]->id;?>").getAttribute('value');
