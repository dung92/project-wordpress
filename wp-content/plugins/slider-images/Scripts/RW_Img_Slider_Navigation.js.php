...
jQuery('#RW_Load_Content_Navigation<?php echo $Rich_Web_Slider;?>').css('max-height', jQuery(
    '#RW_Load_Content_Navigation<?php echo $Rich_Web_Slider;?>').width() * SLHEIGHTR / SLWIDTHR);
...
for (i = 0; i < array_nav<?php echo $Rich_Web_Slider;?>.length; i++) {
    jQuery("<img class='IMHR<?php echo $Rich_Web_Slider;?>' />").attr('src', array_nav<?php echo $Rich_Web_Slider;?>[i])
        .on("load", function() {
            ...
            if (y_nav<?php echo $Rich_Web_Slider;?> == array_nav<?php echo $Rich_Web_Slider;?>.length) {
                ...
                function renderPreview(slider) {
                    ...
                    var delIc<?php echo $Rich_Web_Slider;?> = document.querySelector(
                    ...
                    function delVideo<?php echo $Rich_Web_Slider;?>() {
                        document.querySelector('.flexslider_<?php echo $Rich_Web_Slider;?> ol').style.display =
                            "block";
                        document.querySelector('.flex-direction-nav').style.display = "block";
                ...
                function resp() {
                    ...
                    jQuery(
                            '.flexslider_<?php echo $Rich_Web_Slider;?>,#RW_Load_Content<?php echo $Rich_Web_Slider;?>')
                        .css('height', Math.floor(jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>').width() *
                            SLHEIGHTR / SLWIDTHR));
                    jQuery('.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav .flex-next').css(
                        'height', Math.floor(SLCLWR * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>')
                            .width() / 700));
                    jQuery('.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav .flex-prev').css(
                        'height', Math.floor(SLCLWR * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>')
                            .width() / 700));
                    jQuery('.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav .flex-next').css('width',
                        Math.floor(SLCLWR * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>').width() / 700));
                    jQuery('.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav .flex-prev').css('width',
                        Math.floor(SLCLWR * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>').width() / 700));
                    jQuery('.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav').css('height', Math
                        .floor(SLCLWR * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>').width() / 700));
                    jQuery('.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav a .preview').css('width',
                        Math.floor(SLCLWR * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>').width() / 700));
                    jQuery('.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav .arrow').css('width',
                        Math.floor(SLCLWR * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>').width() / 700));
                    jQuery('.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav .flex-next .preview img')
                        .css('width', Math.floor(SLCLWR * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>')
                            .width() / 700));
                    jQuery('.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav .flex-prev .preview img')
                        .css('width', Math.floor(SLCLWR * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>')
                            .width() / 700));
                    jQuery('.flexslider_<?php echo $Rich_Web_Slider;?> .flex-control-paging li a').css('width', Math
                        .floor(navWidth * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>').width() / 700));
                    jQuery('.flexslider_<?php echo $Rich_Web_Slider;?> .flex-control-paging li a').css('height',
                        Math.floor(navHeight * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>').width() /
                            700));
                    if (navType == 'bottom') {
                        jQuery('.flexslider_<?php echo $Rich_Web_Slider;?> .flex-control-nav li').css('margin-top',
                    ...
                    if (hovEffType == 'slide out') {
                        jQuery(
                            ...
                            .css('right', Math.floor(SLCLWR * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>')
                                .width() / 700) + 'px');
                        jQuery(
                                '.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav .flex-prev .preview img')
                            .css('left', Math.floor(SLCLWR * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>')
                                .width() / 700) + 'px');
                        jQuery(
                                '.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav .flex-next .preview .alt')
                            .css('right', Math.floor(2 * SLCLWR * jQuery(
                                '.flexslider_<?php echo $Rich_Web_Slider;?>').width() / 700) - 1 + 'px');
                        jQuery(
                                '.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav .flex-prev .preview .alt')
                            .css('left', Math.floor(2 * SLCLWR * jQuery(
                                '.flexslider_<?php echo $Rich_Web_Slider;?>').width() / 700) - 2 + 'px');
                    } else if (hovEffType == 'flip out' || hovEffType == 'double flip out') {
                        jQuery('.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav .flex-next .preview')
                            .css('right', Math.floor(SLCLWR * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>')
                                .width() / 700));
                        jQuery('.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav .flex-prev .preview')
                            .css('left', Math.floor(SLCLWR * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>')
                                .width() / 700));
                        jQuery(
                                '.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav .flex-next .preview .alt')
                    ...
                    jQuery(
                            '.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav .flex-next .preview .alt')
                        .css('width', Math.floor(2 * SLCLWR * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>')
                            .width() / 700) + 'px');
                    jQuery(
                            '.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav .flex-prev .preview .alt')
                        .css('width', Math.floor(2 * SLCLWR * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>')
                    ...
                    jQuery(
                            '.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav .flex-next .preview .alt')
                        .css('font-size', Math.floor(SlClPrFS * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>')
                            .width() / 700) + 'px');
                    jQuery(
                            '.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav .flex-prev .preview .alt')
                        .css('font-size', Math.floor(SlClPrFS * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>')
                    ...
                    jQuery(
                            '.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav .flex-next .preview .alt')
                        .css('line-height', Math.floor(SLCLWR * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>')
                            .width() / 700) + 'px');
                    jQuery(
                            '.flexslider_<?php echo $Rich_Web_Slider;?> .flex-direction-nav .flex-prev .preview .alt')
                        .css('line-height', Math.floor(SLCLWR * jQuery('.flexslider_<?php echo $Rich_Web_Slider;?>')
