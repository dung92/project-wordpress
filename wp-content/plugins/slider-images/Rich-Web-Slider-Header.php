...
<style type="text/css">
	...
	{
        .Rich_Web_Header_Main{text-align: center;height: 200px;}
        .Rich_Web_Header_Contacts{margin-top: 75px;}
        .Rich_Web_Header_Free_Version_Shd{float:none;}
        .Rich_Web_Header_Free_Version{top:90px;}
    }
	@media screen and (max-width: 660px) 
	{
        .Rich_Web_Header_Main{height: 230px;}
        .Rich_Web_Header_Contacts{margin-top: 100px;}
    }
</style>
<div class='Rich_Web_Header_Main'>
	...
	<div class="Rich_Web_Header_Contacts">
		<a href="http://rich-web.org/wp-image-slider-navigation/" target="_blank">Demo</a>
