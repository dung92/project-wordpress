...
.error { color: #ff0000; font-size: 12px; margin-top: 5px; margin-bottom: 0; display: block; float: left;}
.RW_IS_InputError {border: 1px solid #ff0000 !important;color: #0e0e0e !important;outline: none !important;}
.RW_IS_InputError:focus {box-shadow: none !important;}
.RW_IS_Name_ErrorAl { font-family: Helvetica; font-size: 13px; font-weight: bold; color: #cc0033; line-height: 20px; background-color: #fce4e4; border: 1px solid #fcc2c3; border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px; float: right; position: absolute; padding: 7px 11px 4px; margin-right: 11px;  position: absolute; top: 40px; left: 39%; }
.RW_IS_Name_ErrorAl:after,.RW_IS_Name_ErrorAl:before {content: '';border: 7px solid transparent;position: absolute;top: 10px;}
.RW_IS_Name_ErrorAl:after { border-right: 7px solid #fce4e4; left: -14px;}
.RW_IS_Name_ErrorAl:before {border-right: 7px solid #fcc2c3;left: -15px;}
.JSaveSlider2Anim:disabled {background: #47bde5;cursor: pointer;border: none;box-shadow: 0px 0px 2px #47bde5;color: #fff;text-shadow: 1px 1px 1px #000000;}
</style>