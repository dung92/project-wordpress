...
<style type='text/css'>
	...
	.RW_IS_C_TTip { visibility: hidden; width: 140px; background-color: #30a9d1; color: #fff; text-align: center; border-radius: 6px; padding: 5px; position: absolute; z-index: 1; bottom: 120%; left: 50%; margin-left: -75px; opacity: 0; transition: opacity 0.3s;}
	.RW_IS_C_TTip::after {content: "";position: absolute;top: 100%;left: 50%;margin-left: -5px;border-width: 5px;border-style: solid;border-color: #30a9d1 transparent transparent transparent;}
	.rich_web_Slider_ID:hover .RW_IS_C_TTip,.JMBSL:hover .RW_IS_C_TTip { visibility: visible; opacity: 1;}
	.rich_web_Slider_ID,.JMBSL{position: relative;cursor:pointer; -moz-user-select: none; -webkit-user-select: none; -ms-user-select:none; user-select:none;-o-user-select:none;	}
	.RW_Support_btn{ padding: 6px 10px !important; width: 100px !important;  cursor: pointer; border: none; color: #fff; text-shadow: 1px 1px 1px #000000; margin: 5px;background-color: #990000;background-image: linear-gradient(147deg, #990000 0%, #ff0000 74%); box-shadow:  linear-gradient(147deg, #990000 0%, #ff0000 74%);}
	.RW_Support_btn:hover{ background-color: #ff0000;background-image: linear-gradient(147deg, #d00b0b 0%, #ff0000 74%);color: #ffffff;}
	.RW_IS_Buttons a {position: absolute;right: 125px;bottom: 5px;}
	...
	.Rich_Web_SliderIm_Relative_Div { position: relative; background: #ffffff; margin: 0 auto; padding: 5px 10px; color: #000000; border: 2px solid #ffffff; float: left; left: 50%; transform: translateX(-50%);  }
	.Rich_Web_SliderIm_Relative_Div p { font-size: 16px; width: 100%; }
	.Rich_Web_SliderIm_Relative_Div span {position: relative;float: left;margin: 5px 2px;padding: 8px 15px;cursor: pointer;border: 1px solid #ffffff;border-radius: 9px;text-shadow: none;width: 35%;}
	.Rich_Web_SliderIm_Relative_Yes{background-color: #63a4ff;background-image: linear-gradient(315deg, #63a4ff 0%, #83eaf1 74%);opacity: 0.7;border: none;color: white;padding: 6px 11px;cursor: pointer;font-size: 13px;border-radius: 7px;}
	.Rich_Web_SliderIm_Relative_No{background-color: #990000;background-image: linear-gradient(147deg, #990000 0%, #ff0000 74%);opacity: 0.7;border: none;color: white;padding: 6px 11px;cursor: pointer;font-size: 13px;border-radius: 7px;margin-right: 10px;}
	.Rich_Web_SliderIm_Relative_Yes:hover , .Rich_Web_SliderIm_Relative_No:hover {opacity: 1;}
	.Rich_Web_IS_Del_Trash { color: #ffffff; font-size: 25px !important; display: inherit; margin-bottom: 9px; color: red;}
</style>