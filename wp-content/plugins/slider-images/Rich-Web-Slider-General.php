...
.RW_IS_Nav_Bar_Button {text-decoration: none;color: #fff;padding: 8px 19px;background-color: #23282d;border: none;font-size: 16px;cursor: pointer;box-shadow: 0px 0px 8px grey;margin: 6px;border-radius: 7px;outline: none;}
.RW_IS_Nav_Bar_Button:hover {color: white;background-color: #6ecae9;outline: none;}
.RW_IS_Nav_Bar_Button.active { color: white; background-color: #6ecae9; outline: none;}
.RW_IS_Nav_Bar { overflow-x: auto; background-color: #23282d; width: 100%; display: inline-flex; scroll: red yellow;}
.RW_IS_Nav_Bar::-webkit-scrollbar {width: 5px;height:5px;}
.RW_IS_Nav_Bar::-webkit-scrollbar-thumb { border-radius: 8px; box-shadow: inset 0 0 5px rgb(0 0 0 / 30%); background-color: #6ecae9; border: 1px solid #47bde5;}
.Rich_Web_IS_Opt_Underline { border-top: 1px solid #6ecae9; width: 100%; margin: -0.3px;}
.RW_IS_Options{width:100%;position: relative;}
.Rich_Web_IS_Content_Options { position:absolute; top:0%; left:0%; width:100% !important; margin-top:0px;	z-index:1;    text-align: center; background-color: #23282d; }
.Rich_Web_IS_Opt_Content {display: inline-block;height: 100%;width: 21%;position: relative;margin: 20px;}
.Rich_Web_IS_Opt_Content_H .Rich_Web_IS_All_Icons, .Rich_Web_IS_Opt_Content:hover .Rich_Web_IS_All_Icons {display: block;position: absolute;bottom: 60px;width: 90%;text-align: center;width: 100%;box-sizing: content-box;position: absolute;background-color: #1c1b1b9e;border-radius: 10px;bottom: 0%;top: 0%;}
.Rich_Web_IS_All_Icons {position: absolute;bottom: 60px;width: 100%;text-align: center;display: none;}
.Rich_Web_IS_Opt_Content_H  .Rich_Web_IS_Icon, .Rich_Web_IS_Opt_Content:hover .Rich_Web_IS_Icon {  visibility: visible; border-radius: 7px;background-color: #055c82;cursor: pointer;display: inline-block;width: 17px;font-size: 15px;padding: 7px;margin-left: 5px;}
.Rich_Web_IS_Opt_Content_H  .Rich_Web_IS_Name, .Rich_Web_IS_Opt_Content:hover .Rich_Web_IS_Name {font-size: 15px;position: absolute;top: -15px;width: 100%;color: white;font-family: initial;text-align: center;display: block;}
.Rich_Web_IS_Name { font-size: 18px; position: absolute; top: 10px; width: 100%; text-align: center; display: none; color: white; font-family: initial;}
.Rich_Web_IS_Opt_Content_H .Rich_Web_IS_Image, .Rich_Web_IS_Opt_Content:hover .Rich_Web_IS_Image {opacity: 0.2;width: 100%;/* height: 80%; */position: relative;background-color: #6ecae9;color: #6ecae9;}
.Rich_Web_IS_Image {display: inline-block;width: 100%;height: 62%;opacity: 1;border-radius: 9px;box-shadow: 0px 0px 8px #5a5757;}
.Rich_Web_IS_Icon_Opt { width: 100%; position: relative; top: 37%;}
.Rich_Web_IS_Icon_Opt > .Rich_Web_IS_Icon:nth-child(1){background-color: #f2cf07;background-image: linear-gradient(315deg, #f2cf07 0%, #55d284 74%);}
.Rich_Web_IS_Icon_Opt > .Rich_Web_IS_Icon:nth-child(2){background-color: #f5d020;background-image: linear-gradient(315deg, #f5d020 0%, #f53803 74%);}
.Rich_Web_IS_Icon_Opt > .Rich_Web_IS_Icon:nth-child(3){background-color: #ff7878;background-image: linear-gradient(315deg, #ff7878 0%, #ff0000 74%);}
.Rich_Web_IS_Icon {    visibility: hidden; cursor: pointer; display: inline-block; background-color: transparent; width: 25px; font-size: 25px; padding: 10px;}
.Rich_Web_IS_Icon > i{ color :#FFFFFF; }
@media only screen and (max-width:1258px){.Rich_Web_IS_Opt_Content{margin:13px;width:21%}}
@media only screen and (max-width:905px){.Rich_Web_IS_Opt_Content{margin:14px;width:28%}}
@media only screen and (max-width:585px){.Rich_Web_IS_Opt_Content{margin:2px;width:31%}}
.rw_is_icon_install , .rw_is_icon_spinner {background-color: #63a4ff;background-image: linear-gradient(315deg, #63a4ff 0%, #83eaf1 74%);border: none;color: white;padding: 7px 12px;cursor: pointer;font-size: 15px;border-radius: 7px;}
.rich_web_imgslide-spin {margin-right:5px; -webkit-animation: imgSliderSpin 2s infinite linear;animation: imgSliderSpin 2s infinite linear;}
@keyframes imgSliderSpin {0% {-webkit-transform: rotate(0deg);transform: rotate(0deg); }100% {-webkit-transform: rotate(359deg);transform: rotate(359deg); }}
.Rich_Web_IS_Trash{color: red;font-size: 25px;display: inherit;margin-bottom: 9px;}
.rw_is_but_cancel {background-color: #990000;background-image: linear-gradient(147deg, #990000 0%, #ff0000 74%);opacity: 0.7;border: none;color: white;padding: 6px 11px;cursor: pointer;font-size: 13px;border-radius: 7px;margin-right: 10px;}
.rw_is_but_delete {background-color: #63a4ff;background-image: linear-gradient(315deg, #63a4ff 0%, #83eaf1 74%);opacity: 0.7;border: none;color: white;padding: 6px 11px;cursor: pointer;font-size: 13px;border-radius: 7px;}
.rw_is_but_cancel:hover , .rw_is_but_delete:hover{ opacity:1;}
.rw_is_but_demo {background-color: #f9c5d1 !important;background-image: linear-gradient(315deg, #f9c5d1 0%, #9795ef 74%) !important;}
.rw_is_but_demo:hover {background-color: #8a00d9;}  
.rw_is_but_demo > a {color:#ffffff; text-decoration:none;}
.rw_is_but_demo > a:hover  i{color:#ffffff; text-decoration:none;}
.rw_is_but_install {background-color: #63a4ff;background-image: linear-gradient(315deg, #63a4ff 0%, #83eaf1 74%);border: none;color: white;padding: 7px 12px;cursor: pointer;font-size: 15px;border-radius: 7px;}
.rw_is_but_install:hover {background-color: #055c82;}
.Table_Data_rich_web_Content{padding:20px;}
.RW_Support_btn,.RW_Pro_Opt_btn{ padding: 6px 10px !important; width: 100px !important;  cursor: pointer; border: none; color: #fff; text-shadow: 1px 1px 1px #000000; margin: 5px;background-color: #990000;background-image: linear-gradient(147deg, #990000 0%, #ff0000 74%); box-shadow:  linear-gradient(147deg, #990000 0%, #ff0000 74%);}
.RW_Support_btn:hover{ background-color: #ff0000;background-image: linear-gradient(147deg, #d00b0b 0%, #ff0000 74%);color: #ffffff;}
.RW_IS_Buttons a:nth-child(1) {position: absolute;right: 125px;bottom: 5px;}
@keyframes scaledAnim { 0%   {transform: scale(0.9);} 100% {transform: scale(1.1);}}
.Rich_Web_IS_Pro_Badge_Overlay { position: absolute; left: 0%; top: 0px; width: 32%; height: 81%; overflow: hidden; pointer-events: none; z-index: 100; -webkit-transition: width 1s ease, height 1s ease; -moz-transition: width 1s ease, height 1s ease; -o-transition: width 1s ease, height 1s ease; transition: width 0.4s ease, height 0.4s ease;}
.Rich_Web_IS_Pro_Badge {margin: 0;padding: 0;color: white;padding: 4px 0px;font-size: 10px;font-family: Arial, Helvetica, sans-serif;line-height: normal;text-transform: uppercase;background: #47a3da;}
.Rich_Web_IS_Pro_Badge::before, .Rich_Web_IS_Pro_Badge::after { content: ''; position: absolute; top: 0; margin: 0 -1px; width: 100%; height: 100%; background: inherit; min-width: 55px}
.Rich_Web_IS_Pro_Badge::before {right: 100%}
.Rich_Web_IS_Pro_Badge::after {left: 100%}
.Rich_Web_IS_Badge_TopLeft { position: absolute; top: 0; left: 0; -ms-transform: translateX(-30%) translateY(0%) rotate(-45deg); -webkit-transform: translateX(-30%) translateY(0%) rotate(-45deg); transform: translateX(-30%) translateY(0%) rotate(-45deg); -ms-transform-origin: top right; -webkit-transform-origin: top right; transform-origin: top right;}
</style>
 <script>jQuery(window).load(function(){jQuery(".RW_IS_Pre_Div").hide()});</script>
<form method="POST" >
	...
	<?php 
	$rw_is_name_arr = array("Slider Navigation", "Fashion Slider", "Slider Carousel", "Flexible Slider", "Dynamic Slider", "Accordion Slider"); 
	$rw_is_install_arr = array("Animation Slider","Circle Thumbnails","Thumbnails Slider & Lightbox","Content Slider");
	$rw_is_types_arr = [];
	$rw_merged_arr = array_merge($rw_is_name_arr,$rw_is_install_arr);
		for($i=0;$i<count($Rich_WebSliderCount);$i++){ 
		array_push($rw_is_types_arr,$Rich_WebSliderCount[$i]->slider_type);
		}
		 $rw_is_types_arr_values = array_values(array_unique($rw_is_types_arr));
		 $rw_is_non_ins = array_values(array_diff($rw_merged_arr, $rw_is_types_arr_values));
	?>
	<div class="RW_IS_Pre_Div"> <div class="RW_IS_Pre_Load"> <div class="RW_IS_Pre_Spin"></div><div class="RW_IS_Pre_Rounder"></div><div class="RW_IS_Pre_Rounder RW_IS_Pre_Rounder_Sec"></div><div class="RW_IS_Pre_Loader_T"> Loading </div></div></div>
	<div class="RW_IS_Buttons" style="position: relative; width: 100%; right: 1%; height: 50px;">
		<a href="https://wordpress.org/support/plugin/slider-images" target="_blank">
   		<input type="button"  class="RW_Support_btn" value="Support" />
		</a>
		<button type="button" id="JAddSlider2" class="JAddSlider2" onclick="addSliderJ2()"> Add Option </button>
	...
	<div class="Table_Data_rich_web_Content_2" >
		...
		<div class="RW_IS_Nav_Bar" id="navigation_bar">
        <button class="RW_IS_Nav_Bar_Button all active" onclick="RW_IS_Filter_Options('all')">All</button>
        <button class="RW_IS_Nav_Bar_Button free" onclick="RW_IS_Filter_Options('free')">Free</button>
        <button class="RW_IS_Nav_Bar_Button pro" onclick="RW_IS_Filter_Options('pro')">Pro</button>
    	</div>
		<div class="RW_IS_Options">
			<hr class="Rich_Web_IS_Opt_Underline">
			<div class="Rich_Web_IS_Fixed_Div"></div>
			<div class='Rich_Web_IS_Content_Options'>
			<?php for($i=0;$i<count($Rich_WebSliderCount);$i++){ 
			$rw_is_opt_type_exp = explode(" ",$Rich_WebSliderCount[$i]->slider_type);
			($rw_is_opt_type_exp[0] == "Slider") ? $rw_is_opt_type = $rw_is_opt_type_exp[1] : $rw_is_opt_type = $rw_is_opt_type_exp[0];
				?>
				<div id='Rich_Web_IS_Opt_Content_<?php echo $Rich_WebSliderCount[$i]->id ?>' class="Rich_Web_IS_Opt_Content  <?php  print in_array($Rich_WebSliderCount[$i]->slider_type, $rw_is_name_arr) ?  'free' :  'pro' ;?>" >
					<img src='<?php echo 'https://rich-web.org/RW-Image-slider/Theme-Images/RW_Img_Slider_'.$rw_is_opt_type.'.png';?>' alt="<?php echo $Rich_WebSliderCount[$i]->slider_name;?>" class="Rich_Web_IS_Image">
					<div class='Rich_Web_IS_All_Icons'>
						<div class="Rich_Web_IS_Icon_Opt" id="Rich_Web_IS_Icon_Opt_<?php echo $Rich_WebSliderCount[$i]->id ?>">
                   			<div class='Rich_Web_IS_Icon'   onclick="Rich_Web_IS_Edit_Opt('<?php echo $Rich_WebSliderCount[$i]->id;?>')">
                   			    <i class='Rich_Web_IS_Edit rich_web rich_web-pencil'></i>
                   			</div>    
                   			<div class='Rich_Web_IS_Icon'  onclick="Rich_Web_IS_Copy_Opt('<?php echo $Rich_WebSliderCount[$i]->id;?>')">
                   			    <i class='Rich_Web_IS_Copy rich_web rich_web-files-o'></i>
                   			</div>    
							<?php if ( $Rich_WebSliderCount[$i]->id > 6) { ?>
							<div class='Rich_Web_IS_Icon'  onclick="Rich_Web_IS_Delete_Opt('<?php echo $Rich_WebSliderCount[$i]->id;?>')">
								<i class='Rich_Web_IS_Del rich_web rich_web-trash'></i>
							</div> 
							<?php } ?>
						</div>
					</div>	
					<h4 class="Rich_Web_IS_Name "><?php echo $Rich_WebSliderCount[$i]->slider_name;?></h4>
				</div>
			<?php } ?>
			<?php for($y=0;$y<count($rw_is_non_ins);$y++){
			$rw_is_bool =  in_array($rw_is_non_ins[$y], $rw_is_name_arr) ?  'free' :  'pro' ;
			$rw_is_opt_type_exp = explode(" ",$rw_is_non_ins[$y]);
			($rw_is_opt_type_exp[0] == "Slider") ? $rw_is_opt_type = $rw_is_opt_type_exp[1] : $rw_is_opt_type = $rw_is_opt_type_exp[0];
				?>
				<div id='Rich_Web_IS_Opt_Content_<?php echo $rw_is_opt_type;?>' class="Rich_Web_IS_Opt_Content <?php echo $rw_is_bool; ?>" >
					<img src='<?php echo 'https://rich-web.org/RW-Image-slider/Theme-Images/RW_Img_Slider_'.$rw_is_opt_type.'.png';?>' alt="<?php echo $rw_is_non_ins[$y];?>" class="Rich_Web_IS_Image">
					<?php if($rw_is_bool == 'pro'){ ?>
					<div class="Rich_Web_IS_Pro_Badge_Overlay">
                    	<span class="Rich_Web_IS_Badge_TopLeft Rich_Web_IS_Pro_Badge">Pro</span>
                	</div>
					<?php } ?>
					<div class='Rich_Web_IS_All_Icons'>
						<div class="Rich_Web_IS_Icon_Opt" id="Rich_Web_IS_Icon_Opt_<?php echo $rw_is_opt_type ?>">
						<?php if ($rw_is_bool == 'free') {?>
								<div class='Rich_Web_IS_Icon rw_is_but_demo'>
								<a onclick="Rich_Web_IS_DPre('<?php echo $rw_is_opt_type;?>')">
								<i class='rich_web rich_web-eye'></i></a></div>
                            	<button class="rw_is_but_install" onclick="Rich_Web_IS_Insert('<?php echo $rw_is_opt_type;?>')">
								<i class="Rich_Web_Tabs_Install rich_web rich_web-cloud-download"></i> Insert</button> 
					<?php	}else if($rw_is_bool == 'pro'){ ?>
                            <button class="rw_is_but_install"
                            onclick="Rich_Web_IS_DPre('<?php echo $rw_is_opt_type;?>')"><i
                            class="Rich_Web_Tabs_Install rich_web rich_web-photo"></i> Pro Only</button>
					<?php } ?>
						</div>
					</div>	
					<h4 class="Rich_Web_IS_Name "><?php echo $rw_is_non_ins[$y];?></h4>
				</div>
			<?php } ?>
				</div>
			</div>
		...
		<div class="Table_Data_rich_web2_2">
			<table class="rich_web_SaveSl_Table">
				...
				<tr>
					<td>
						<input type="text" class="rich_web_Text_Field" name="rich_web_slider_name" id="rich_web_slider_name" required oninput="Rich_Web_IS_Name_Available()" placeholder="* Required">
						<div class="RW_IS_Name_ErrorAl " style="display:none;">
					...
					<td class="SlType">
						<select class="rich_web_Text_Field" id="rich_web_slider_type" name="rich_web_slider_type">
							<?php  
						for ($s=0; $s < count($rw_is_types_arr_values); $s++) { ?>
							<option value="<?php echo $rw_is_types_arr_values[$s]; ?>"><?php echo $rw_is_types_arr_values[$s]; ?></option>
						<?php }
							?>
						</select>
					</td>
