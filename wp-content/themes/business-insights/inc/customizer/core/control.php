 ...
 */
class Business_Insights_Dropdown_Taxonomies_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class Business_Insights_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @access public
 */
class Business_Insights_Customize_Section_Upsell extends WP_Customize_Section {
...
if ( ! function_exists( 'business_insights_is_select_page_slider' ) ) :
	 ...
	 */
	function business_insights_is_select_page_slider( $control ) {
