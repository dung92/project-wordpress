...
<?php if (business_insights_get_option('show_slider_section') == 1) {
    $business_insights_body_aid_class = 'slider-enabled';
}?>
<body <?php body_class($business_insights_body_aid_class); ?>>
...
<div id="page" class="site site-bg <?php echo esc_attr($business_insights_homepage_layout); ?>">
    <a class="skip-link screen-reader-text" href="#main"><?php esc_html_e('Skip to content', 'business-intuition'); ?></a>
                        ...
                        <div class="meta-info-wrapper">
                            ...
                            <div class="meta-info-col">
                                <div class="meta-info meta-info-tel">
                                    ...
                                    <div class="meta-info-child meta-info-detail">
                                        <h5 class="meta-info-title secondary-font"><?php esc_html_e( 'Telephone', 'business-intuition' ); ?></h5>
                            ...
                            <div class="meta-info-col">
                                <div class="meta-info meta-info-email">
                                    ...
                                    <div class="meta-info-child meta-info-detail">
                                        <h5 class="meta-info-title secondary-font"><?php esc_html_e( 'Email', 'business-intuition' ); ?></h5>
                            ...
                            <div class="meta-info-col">
                                <div class="meta-info meta-info-map">
                                    ...
                                    <div class="meta-info-child meta-info-detail">
                                        <h5 class="meta-info-title secondary-font"><?php esc_html_e( 'Location', 'business-intuition' ); ?></h5>
            ...
            <div class="container">
                <nav class="main-navigation" role="navigation">
                    <span class="toggle-menu" aria-controls="primary-menu" aria-expanded="false">
                        <span class="screen-reader-text"><?php esc_html_e('Primary Menu', 'business-intuition'); ?></span>
                        <i class="ham"></i>
                    </span>
