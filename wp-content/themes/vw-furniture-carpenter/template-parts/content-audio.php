...
<article id="post-<?php the_ID(); ?>" <?php post_class('inner-service'); ?>>
  <div class="post-main-box">
    ...
    <div class="new-text">
      ...
      <?php if( get_theme_mod( 'vw_furniture_carpenter_toggle_postdate',true) != '' || get_theme_mod( 'vw_furniture_carpenter_toggle_author',true) != '' || get_theme_mod( 'vw_furniture_carpenter_toggle_comments',true) != '') { ?>
        <div class="post-info">
          <?php if(get_theme_mod('vw_furniture_carpenter_toggle_postdate',true)==1){ ?>
            <i class="fas fa-calendar-alt"></i><span class="entry-date"><a href="<?php echo esc_url( get_day_link( $vw_furniture_carpenter_archive_year, $vw_furniture_carpenter_archive_month, $vw_furniture_carpenter_archive_day)); ?>"><?php echo esc_html( get_the_date() ); ?><span class="screen-reader-text"><?php echo esc_html( get_the_date() ); ?></span></a></span><span>|</span>
          <?php } ?>
          ...
          <?php if(get_theme_mod('vw_furniture_carpenter_toggle_comments',true)==1){ ?>
            <i class="fa fa-comments" aria-hidden="true"></i><span class="entry-comments"><?php comments_number( __('0 Comment', 'vw-furniture-carpenter'), __('0 Comments', 'vw-furniture-carpenter'), __('% Comments', 'vw-furniture-carpenter') ); ?> </span><span>|</span>
          <?php } ?>
